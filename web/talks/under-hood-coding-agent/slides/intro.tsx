...
export default function IntroSlide({ activeSubstep = 0 }: { activeSubstep?: number }) {
  return (
...
export const notes = `Overview of the talk structure. Part 1 covers what a coding agent actually is: the model, tools, environment, and the ReACT loop that ties them together. Part 2 dives into five fundamental context engineering concepts that make coding agents effective.`
